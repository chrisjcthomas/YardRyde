...
## The Only Real Risk
**Multi-device testing in Hour 2**: This is where things break (CORS, WebSocket drops, phone browser quirks). Spend 15-20 minutes here. If it doesn't work by 2:20, you'll panic.
